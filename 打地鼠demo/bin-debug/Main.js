...
var Main = (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        //进入时获得游戏数据
                        _a = that;
                        return [4 /*yield*/, that.getBaseData()];
                    case 4:
                        //进入时获得游戏数据
                        _a.baseData = _b.sent();
                        return [4 /*yield*/, RES.loadGroup("loading", 0, loadingView_1)];
                    case 5:
                        _b.sent();
                        setTimeout(function () {
                            egret.Tween.get(loadingView_1).to({ alpha: 0 }, 200).call(function () {
    ...
    Main.prototype.createGameScene = function () {
        ...
        //开始创建场景
        AppScene.createScene(root.gameLayer, root.topLayer, root.width, root.height, root.baseData);
    };
    /**
    ...
    //进入时获得游戏数据
    Main.prototype.getBaseData = function () {
        var root = this;
        return new Promise(function (resolve, reject) {
            // var param = "";
            // var url="";
            // Utils.Method.Post(url, param, function (event: egret.Event) {
            // },root);
            //使用mock数据
            Utils.Method.readTextFile("mock/data.json", function (text) {
                var data = typeof text == "string" ? JSON.parse(text) : text;
                resolve(data.gameData[0]);
            });
        });
    };
    return Main;

...
class LoadingUI extends egret.Sprite implements RES.PromiseTaskReporter {
    ...
    private percentText: egret.TextField;
        private maskRect;
        private bar: egret.Sprite;
        private bright: egret.Sprite;
        private loading;
        private loadBarWidth: number;
    ...
    private loadingTipTimer: egret.Timer;
    private loadingTipCount: number = 0;
    private loadingTipStr: string = "loading";

    private loadingTipAnimation(event: egret.TimerEvent) {
